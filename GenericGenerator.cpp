...
namespace LSys {
  ...
  void GenericGenerator::OutputBounds(const Turtle& t)
  {
    ...
    // Output start point
    *boundsOutput << "start" << '\n';
    *boundsOutput << "  "; OutputVec(*boundsOutput, startPoint); *boundsOutput << '\n';
    *boundsOutput << "\n";
  ...
  void GenericGenerator::Polygon(const Turtle& t, const LSys::Polygon& p)
  {
    ...
    *out << " " << "FrontMaterial: " << frontColor << '\n';
    *out << " " << "FrontTexture: " << frontTexture << '\n';
    *out << " " << "BackMaterial: " << backColor << '\n';
    *out << " " << "BackTexture: " << backTexture << '\n';
    *out << '\n';
  ...
  void GenericGenerator::DrawObject(
    const Turtle& t, const Module& m, int nargs, const float args[])
  {
    ...
    *out << " " <<  "  Up:"; OutputVec(*out, t.CurrentUp()); *out << '\n';
    *out << " " <<  "  nargs: " << nargs << '\n';
